            ...
            <v-container class="">
                ...
                <v-row>
                    <v-col cols="3"><v-select v-model="seleccio" density="compact"
                            :items="['Pendents', 'Acceptades', 'Tancades']"></v-select></v-col>
                    <v-col cols="6"></v-col>
                        ...
                        <v-dialog v-model="dialog" width="auto">
                            <v-card>
                                ...
                                <v-text-field v-model="idcomanda" :counter="10" label="ID comanda"
                                    required hide-details @key.up.enter="buscar"></v-text-field>
                                <v-card-actions>
                ...
                <v-row>
                    <v-container>
                        ...
                        ]" v-for="(comanda, index) in comandes.filter(comanda => comanda.estat === seleccio)"
                            :key=index>
